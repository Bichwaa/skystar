import { version, unref, inject, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, hasInjectionContext, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentInstance, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/h3/dist/index.mjs';
import { getActiveHead } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue-router/dist/vue-router.node.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/ufo/dist/index.mjs';
import { defu } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/reports-dx7DEsus.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/settings-DaXkc4uo.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-time-manage",
    path: "/admin/time-manage",
    meta: {},
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/time-manage-B122FkSz.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/index-2MaCYP4z.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/login-8lzfb5_U.mjs').then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/register-jaBGeC97.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-us3HoH8l.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-Dpq37Hnu.mjs').then((r) => r.default || r));
