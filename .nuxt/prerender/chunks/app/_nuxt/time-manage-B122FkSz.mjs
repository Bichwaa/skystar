import { _ as _sfc_main$1 } from './Content-C9baeICD.mjs';
import { mergeProps, useSSRContext } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue/index.mjs';
import { ssrRenderComponent } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Content = _sfc_main$1;
  _push(ssrRenderComponent(_component_Content, mergeProps({ title: "Time Manage" }, _attrs), null, _parent));
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/time-manage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const timeManage = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { timeManage as default };
//# sourceMappingURL=time-manage-B122FkSz.mjs.map
