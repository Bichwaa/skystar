...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/@unhead/ssr/dist/index.mjs';
...
import { createHooks } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/unstorage/drivers/fs.mjs';
...
import { isAbsolute } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/bichwaa/Desktop/work/skystar/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/bichwaa/Desktop/work/skystar/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/bichwaa/Desktop/work/skystar","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/bichwaa/Desktop/work/skystar/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/bichwaa/Desktop/work/skystar/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/bichwaa/Desktop/work/skystar/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/bichwaa/Desktop/work/skystar/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _gSs6XffK9p = (function(nitro) {
...
const _lazy_kSVkp6 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_kSVkp6, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///home/bichwaa/Desktop/work/skystar/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/bichwaa/Desktop/work/skystar/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
