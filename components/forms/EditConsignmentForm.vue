...
function initializeData(){
    payload.value.customerId = props.consignmentdata.customerId;
    payload.value.luggage = props.consignmentdata.luggage;
    payload.value.modeOfTransport = props.consignmentdata.modeOfTransport;
    payload.value.vesselName = props.consignmentdata.vesselName;
    payload.value.vesselNumber = props.consignmentdata.vesselNumber;
    payload.value.voyageNumber = props.consignmentdata.voyageNumber;
    payload.value.truckNumber = props.consignmentdata.truckNumber;
    payload.value.flightNumber = props.consignmentdata.flightNumber;
    payload.value.flightName = props.consignmentdata.flightName;
    payload.value.destination = props.consignmentdata.destination;
    payload.value.portOfLoading = props.consignmentdata.portOfLoading;
    payload.value.hasLooseCargo = props.consignmentdata.hasLooseCargo;
    payload.value.hasContainers = props.consignmentdata.hasContainers;
    payload.value.overseerId = props.consignmentdata.overseerId;
    payload.value.transporterId = props.consignmentdata.transporterId;
    payload.value.consigneeId = props.consignmentdata.consigneeId;
    payload.value.bookingNumber = props.consignmentdata.bookingNumber;
    payload.value.blNumber = props.consignmentdata.blNumber;
    payload.value.totalWeight = props.consignmentdata.totalWeight;
    payload.value.etd = props.consignmentdata.etd;
    payload.value.eta = props.consignmentdata.eta;
}
