<template>
  ...
  function viewClicked(id){
    // Navigate to the customer's statement details page
    const router = useRouter();
    router.push(`/admin/statements/${id}`);
  }
